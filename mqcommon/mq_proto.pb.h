...
inline ::Fy_mq::ExchangeType declareExchangeRequest::_internal_exchange_type() const {
  return static_cast< ::Fy_mq::ExchangeType >(_impl_.exchange_type_);
}
...
inline const ::Fy_mq::BasicProperties& basicPublishRequest::_internal_properties() const {
  const ::Fy_mq::BasicProperties* p = _impl_.properties_;
...
inline ::Fy_mq::BasicProperties* basicPublishRequest::release_properties() {
  ...
  ::Fy_mq::BasicProperties* temp = _impl_.properties_;
