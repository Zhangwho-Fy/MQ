...
//     Fy_mq::BasicProperties properties;
//     properties.set_id(Fy_mq::UUIDHelper::uuid());
//     properties.set_deliver_mode(Fy_mq::DeliverMode::DURABLE);
...
//     ASSERT_EQ(mmp->getable_count("queue1"), 5);
//     Fy_mq::MessagePtr msg1 = mmp->front("queue1");
...
//     Fy_mq::MessagePtr msg2 = mmp->front("queue1");
...
//     Fy_mq::MessagePtr msg3 = mmp->front("queue1");
...
//     Fy_mq::MessagePtr msg4 = mmp->front("queue1");
...
//     Fy_mq::MessagePtr msg5 = mmp->front("queue1");
...
Fy_mq::MessageManager::ptr mmp1;
class MessageTest2 : public testing::Environment {
    public:
        virtual void SetUp() override {
            mmp1 = std::make_shared<Fy_mq::MessageManager>("./data/message/");
        }
        virtual void TearDown() override {
            mmp1->clear();
        }
