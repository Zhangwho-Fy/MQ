...
PROTOBUF_NAMESPACE_OPEN
template<> ::Fy::AddRequest* Arena::CreateMaybeMessage<::Fy::AddRequest>(Arena*);
template<> ::Fy::AddResponse* Arena::CreateMaybeMessage<::Fy::AddResponse>(Arena*);
template<> ::Fy::TranslateRequest* Arena::CreateMaybeMessage<::Fy::TranslateRequest>(Arena*);
template<> ::Fy::TranslateResponse* Arena::CreateMaybeMessage<::Fy::TranslateResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Fy {
...
class TranslateRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Fy.TranslateRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Fy.TranslateRequest)
 private:
  class _Internal;
...
class TranslateResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Fy.TranslateResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Fy.TranslateResponse)
 private:
  class _Internal;
...
class AddRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Fy.AddRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Fy.AddRequest)
 private:
  class _Internal;
...
class AddResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Fy.AddResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Fy.AddResponse)
 private:
  class _Internal;
...
inline const std::string& TranslateRequest::msg() const {
  // @@protoc_insertion_point(field_get:Fy.TranslateRequest.msg)
...
void TranslateRequest::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Fy.TranslateRequest.msg)
}
inline std::string* TranslateRequest::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:Fy.TranslateRequest.msg)
  return _s;
}
...
inline std::string* TranslateRequest::release_msg() {
  // @@protoc_insertion_point(field_release:Fy.TranslateRequest.msg)
  return msg_.Release();
}
inline void TranslateRequest::set_allocated_msg(std::string* msg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Fy.TranslateRequest.msg)
}
...
inline const std::string& TranslateResponse::msg() const {
  // @@protoc_insertion_point(field_get:Fy.TranslateResponse.msg)
  return _internal_msg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void TranslateResponse::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Fy.TranslateResponse.msg)
}
inline std::string* TranslateResponse::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:Fy.TranslateResponse.msg)
  return _s;
}
...
inline std::string* TranslateResponse::release_msg() {
  // @@protoc_insertion_point(field_release:Fy.TranslateResponse.msg)
  return msg_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Fy.TranslateResponse.msg)
}
...
inline int32_t AddRequest::num1() const {
  // @@protoc_insertion_point(field_get:Fy.AddRequest.num1)
...
inline void AddRequest::set_num1(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Fy.AddRequest.num1)
}
...
inline int32_t AddRequest::num2() const {
  // @@protoc_insertion_point(field_get:Fy.AddRequest.num2)
...
inline void AddRequest::set_num2(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Fy.AddRequest.num2)
}
...
inline int32_t AddResponse::result() const {
  // @@protoc_insertion_point(field_get:Fy.AddResponse.result)
...
inline void AddResponse::set_result(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Fy.AddResponse.result)
}
